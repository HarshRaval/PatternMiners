...
public class WordCleaner {
	...
	public HashSet<String> loadProductNameWords(String productName, HashSet<String> words){
	...
	public String matchQueryWordToProduct(String oldQuery, HashSet<String> prodWords){
